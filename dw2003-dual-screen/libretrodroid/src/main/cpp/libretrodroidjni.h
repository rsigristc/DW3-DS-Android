...
JNIEXPORT jbyteArray JNICALL Java_com_swordfish_libretrodroid_LibretroDroid_readMemory(JNIEnv* env, jclass obj, jint memoryId, jint offset, jint length);
JNIEXPORT void JNICALL Java_com_swordfish_libretrodroid_LibretroDroid_writeMemory(JNIEnv* env, jclass obj, jint memoryId, jint offset, jbyteArray data);
