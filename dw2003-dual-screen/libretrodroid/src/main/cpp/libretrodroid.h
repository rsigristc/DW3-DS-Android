...
public:
    ...
    std::vector<int8_t> readMemory(unsigned int memoryId, size_t offset, size_t length);
    void writeMemory(unsigned int memoryId, size_t offset, const int8_t* data, size_t length);
