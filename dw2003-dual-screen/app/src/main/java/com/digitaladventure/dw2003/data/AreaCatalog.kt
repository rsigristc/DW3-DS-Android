...
object AreaCatalog {
    private val names = mapOf(
        ...
        0x0213 to "El Dorado", 0x0214 to "Centro Administrativo 1P", 0x0217 to "Centro Administrativo 2P",
        0x0218 to "Sala del Maestro", 0x021B to "Alcantarillas de Asuka", 0x021C to "Sala de Control",
        ...
        0x0243 to "Catacumba", 0x0247 to "Desierto Sur", 0x0248 to "Desierto del Ruido",
        ...
        0x0255 to "Sala Secreta", 0x0257 to "Desierto del Ruido Sur", 0x0258 to "Desierto Mobius",
        0x0259 to "Desierto Mobius 2", 0x025A to "Torre de los Espejismos",
        0x025B to "Salón de los Espejismos", 0x025C to "Sala de los Espejismos",         0x025D to "Ciudad Byakko",
        ...
        0x0267 to "Gimnasio Legendario", 0x0268 to "Agujero Kulon", 0x026F to "Ciudad Genbu",
