...
object CompanionUiText {
    ...
    private val englishAreas = mapOf(
        ...
        0x0213 to "El Dorado", 0x0214 to "Admin Center 1F", 0x0217 to "Admin Center 2F",
        0x0218 to "Master Room", 0x021B to "Asuka Sewers", 0x021C to "Control Room",
        ...
        0x0242 to "Jungle Shrine", 0x0243 to "Catacomb", 0x0247 to "South Badland",
        ...
        0x0254 to "Sewers", 0x0255 to "Secret Room", 0x0257 to "South Noise Desert",
        ...
        0x0267 to "Legendary Gym", 0x0268 to "Kulon Pit", 0x026F to "Genbu City",
